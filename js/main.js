...
$(function() {
  var bookmark = {
    data: [{
      name: '博客园',
      link: 'https://www.cnblogs.com/murkuo/',
...
$(function() {
  var search = {
    data: [{
      ...
      searchlink:'https://pirate-bays.net/search',
      searchname:'q',
      colour:'#1087eb',
      placeholder:'海盗湾'
    }, {
      name:'盘他',
      icon:'https://panother.com/images/avatars/010_700x700.jpeg',
      searchlink:'https://www.panother.com/search',
      searchname:'query',
      colour:'#1087eb',
      placeholder:'盘他搜索'
    }, {
...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "航の导航 | Good evening";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "航の导航 | Good afternoon";
}
if (time < 12) {
  document.getElementById("title").innerHTML = "航の导航 | Good morning";
}
if (time < 5) {
  document.getElementById("title").innerHTML = "航の导航 | Stay up late again";
}
//title问候语结束
